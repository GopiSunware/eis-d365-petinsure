...
const getInitialMessage = (): ChatMessageType => {
  const timeOfDay = new Date().getHours();
  const greeting = timeOfDay < 12 ? 'Good morning' : timeOfDay < 17 ? 'Good afternoon' : 'Good evening';

  return {
    role: 'assistant',
    content: `${greeting}! 👋 Welcome to **EIS Admin Portal**.\n\nI can help you with:\n• ⚙️ System configurations and settings\n• 💰 Cost monitoring and optimization\n• 📋 Audit logs and compliance\n• 🔧 Service health and diagnostics\n• 👤 User and role management\n\nWhat would you like to manage?`
  };
};
      ...
      <div className="flex-shrink-0 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white p-4">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold">Admin Assistant</h2>
          </div>
          <button
            onClick={onClose}
      ...
      {!hasNoProviders && (
        <div className="flex-shrink-0 border-t border-gray-200 p-4 bg-white">
          <ChatInput
            ...
            placeholder={loading ? 'Waiting for response...' : 'Ask about admin features...'}
          />
